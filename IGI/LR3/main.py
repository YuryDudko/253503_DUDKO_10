...
def main():
    ...
    while True:
        ...
        match a:
            case "1":
                print("Task 1: Compute Function Value")
                task_1()
            case '2':
                print("\nTask 2: Find Sequence Sum")
                task_2()
            case '3':
                print("\nTask 3: Count Characters in Text")
                task_3()
            case '4':
                print("\nTask 4: Analyze Text")
                task_4()
            case '5':
                print("\nTask 5: Find the minimum positive element and sum of elements between the first and last positive elements in the given list.")
                task_5()
            case '0':
                break
            case _:
